<%@page import="icp.web.UI.UserInfoUI"%>
...
<body>
		...
		<table border="0px" class="location1">
			<tr height="35px">
				...
				<td width="400px"><input style="width: 300px; height: 25px;"
					type="text" id="searchdiv" size="30px" name="keyWord" /></td>
	...
	<!-- 显示已发送通知，使用表格 -->
	<div style="position: absolute; left: 20%; top: 40%; height: 400px; width: 80% ;overflow-y: scroll">
		<form >
			<table border="0px" >
				<%=UserInfoUI.ShowMyAnnouncement(request.getParameter("userID")) %>
			</table>
		</form>
	</div>
</body>
